...
export default function Dashboard() {
  ...
  const [currentFilament, setCurrentFilament] = useState<FilamentInfo | null>(null);
  ...
  const notificationCacheRef = useRef<Record<string, { startAt: string; notifiedAt: string }>>({});
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [
        ...
        axios.get('http://localhost:5000/api/service-providers').catch((error) => {
  ...
  useEffect(() => {
    ...
    const fetchFilament = async () => {
      ...
      try {
        ...
        const res = await axios.get(`http://localhost:5000/api/filaments/${currentPrint.filamentId}`);
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (stored) {
        ...
        const parsed = JSON.parse(stored) as Record<string, { startAt: string; notifiedAt: string }>;
  ...
  const resolveResponsibleName = (responsibleId?: string, responsibleName?: string) => {
    ...
    if (responsibleId) {
      ...
      const provider = serviceProviders.find(item => item.id === responsibleId);
  ...
  const serviceQueueItems = useMemo<QueueItem[]>(() => {
    ...
    designTasks.forEach((task) => {
      ...
      items.push({
        ...
        responsibleName: resolveResponsibleName(task.responsibleId, task.responsibleName)
    ...
    return serviceProviders
      ...
      .map(provider => {
        ...
        const items = priorityQueue.filter(item => {
          ...
          if (item.responsibleId && item.responsibleId === provider.id) return true;
          ...
          if (item.responsibleName && normalizeText(item.responsibleName) === normalizeText(provider.name)) return true;
  ...
  const activeServiceTab = serviceProviderTabs.find(tab => tab.id === activeWorkTab) || null;
  ...
  useEffect(() => {
    ...
    const resolveProviderEmail = (item: QueueItem) => {
      ...
      if (item.responsibleId) {
        ...
        const provider = serviceProviders.find(p => p.id === item.responsibleId);
      ...
      if (item.responsibleName) {
        ...
        const provider = serviceProviders.find(p => normalizeText(p.name) === normalizeText(item.responsibleName));
    ...
    priorityQueue.forEach((item) => {
      ...
      const typeLabel =
        ...
        item.type === 'print' ? 'Impressão' : item.type === 'design' ? 'Design' : 'Pintura';
      ...
      const body = [
        ...
        item.type === 'print' ? 'Notificação enviada a todos os funcionários.' : ''
      ...
      axios.post('http://localhost:5000/api/notifications/email', {
    ...
    if (cacheChanged) {
      ...
      try {
        ...
        window.localStorage.setItem(NOTIFICATION_STORAGE_KEY, JSON.stringify(cache));
                ...
                return (
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-colors ${
                      ...
                      isActive ? 'bg-white text-brand-purple' : 'bg-white/15 text-white hover:bg-white/25'
                  ...
                  >
                    ...
                    <span className={`ml-2 inline-flex items-center justify-center rounded-full px-2 py-0.5 text-[10px] font-bold ${
                      ...
                      isActive ? 'bg-brand-purple text-white' : 'bg-white/30 text-white'
                            ...
                            <div className="group relative">
                              ...
                              <button 
                                ...
                                onClick={() => {
                                  ...
                                  setEditTimeValue(remainingTime.substring(0, 5));
                  ...
                  {currentPrint.printStatus === 'Staged' && (
                    ...
                    <>
                      ...
                      {currentFilament && (
                        ...
                        <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-sm text-gray-700">
                          ...
                          <span
                            ...
                            style={{ backgroundColor: currentFilament.colorHex || '#ffffff' }}
                          ...
                          <span className="font-medium">
                            ...
                            {currentFilament.color ? `Filamento: ${currentFilament.color}` : 'Filamento: cor não informada'}
                  ...
                  <>
                    ...
                    {activeServiceTab.items.length > 0 ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                          ...
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <span className={`px-2 py-1 text-xs font-semibold rounded-full ${getQueueTypeBadge(activeServiceTab.items[0].type)}`}>



                              {getQueueTypeLabel(activeServiceTab.items[0].type)}
                            ...
                            {activeServiceTab.items[0].rank && (
                              ...
                              <span className="text-xs font-semibold text-gray-500">Prioridade #{activeServiceTab.items[0].rank}</span>
                          ...
                          <p className="text-sm text-gray-500">
                            ...
                            Início previsto: {formatDateTime(activeServiceTab.items[0].scheduledAt)}
                        ...
                        {activeServiceTab.items.length > 1 && (
                          ...
                          <div>
                            ...
                            <p className="text-xs font-semibold text-gray-500 uppercase mb-2">Próximos na fila</p>
                            ...
                            <ul className="space-y-2">
                              ...
                              {activeServiceTab.items.slice(1, 4).map((item) => (



                                <li key={item.key} className="flex items-center justify-between gap-3 rounded-lg border border-gray-100 bg-white px-3 py-2">
                                  ...
                                  <div className="min-w-0">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className={`px-2 py-0.5 text-xs font-semibold rounded-full ${getQueueTypeBadge(item.type)}`}>
                                  ...
                                  <span className="text-xs text-gray-500 whitespace-nowrap">{formatDateTime(item.scheduledAt)}</span>
                      ...
                      <div className="py-8 text-gray-400 text-center">
                        ...
                        <p className="text-sm">Nenhum serviço pendente para este responsável.</p>
              ...
              <table className="w-full text-left table-fixed">
                ...
                <thead className="bg-gray-50 text-gray-500 text-xs uppercase">
                  ...
                  <tr>
                    ...
                    <th className="px-6 py-3 w-[140px]">Entrega/Início</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  ...
                  {priorityQueue.map((item) => {
                    ...
                    const statusLabel = item.type === 'print'

                      ? item.status

                      : (isServiceActive(item.status) ? 'Ativo' : 'Concluído');

                    const detailHref = item.type === 'print'
                    ...
                    const scheduleLabel = item.type === 'print'
                    ...
                    const saleItem = item.type === 'print'
                      ...
                      <tr key={item.key} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 font-medium text-gray-900">
                          ...
                          <span className={`inline-flex items-center justify-center w-6 h-6 rounded-full text-xs font-bold ${
                            ...
                            priorityValue <= 1 ? 'bg-red-600 text-white' :

                            priorityValue <= 3 ? 'bg-orange-100 text-orange-800' :
                        ...
                        <td className="px-6 py-4 text-gray-700">
                          ...
                          <div className="flex items-center gap-2 min-w-0">
                            ...
                            <div className="flex-1 min-w-0 max-w-[240px] overflow-x-auto whitespace-nowrap">

                              {item.title}

                            </div>

                            {item.type === 'print' && item.incidents && item.incidents.length > 0 && (

                              <button

                                onClick={() => {

                                  const target = queue.find((sale) => sale.id === item.saleId);
