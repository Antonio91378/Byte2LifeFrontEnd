    ...
    <div className="max-w-5xl mx-auto pb-12">
      <div className="flex items-center gap-3 mb-8">
        <div className="p-3 bg-brand-purple/10 rounded-xl">
          <svg className="w-8 h-8 text-brand-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
        </div>
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Novo Item de Estoque</h1>
          <p className="text-gray-500">Cadastre um novo item impresso disponível para venda.</p>
        </div>
      </div>
