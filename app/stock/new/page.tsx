...
export default function NewStockItemPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    cost: 0,
    productionCost: 0,
    printQuality: "Normal", // Default to Normal
    nozzleDiameter: "",
    layerHeight: "",
    hasCustomArt: false,
    hasPainting: false,
    ...
    const calculateCost = async () => {
      ...
      try {
        ...
        setFormData((prev) => ({
          ...
          printTime:
            !isTimeManual && res.data.estimatedTimeHours
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const res = await axios.post(
        "http://localhost:5000/api/stock/upload",
        formDataUpload,
        {
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500">
            Cadastre um novo item impresso disponível para venda.
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, printQuality: e.target.value })
                  }
                >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-100 text-center mb-4">
              <span className="block text-sm text-green-600 font-medium mb-1">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4">
                <div className="flex justify-between items-center mb-2 pb-2 border-b border-gray-200">
                  ...
                  <span className="text-lg font-bold text-gray-800">
                    {(costDetails.totalProductionCost || 0).toLocaleString(
                      "pt-BR",
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-xs text-gray-600">
                    <span>Material</span>
                    <span>
                      {(costDetails.materialCost || 0).toLocaleString("pt-BR", {
                        style: "currency",
                        currency: "BRL",
                      })}
                    </span>
                  ...
                  <div className="flex justify-between text-xs text-gray-600">
                    <span>Energia</span>
                    <span>
                      {(costDetails.energyCost || 0).toLocaleString("pt-BR", {
                        style: "currency",
                        currency: "BRL",
                      })}
                    </span>
                  ...
                  <div className="flex justify-between text-xs text-gray-600">
                    <span>Máquina</span>
                    <span>
                      {(costDetails.machineCost || 0).toLocaleString("pt-BR", {
                        style: "currency",
                        currency: "BRL",
                      })}
                    </span>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              <label
                className={`cursor-pointer border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center transition-colors ${uploading ? "bg-gray-50 opacity-50 cursor-not-allowed" : "hover:bg-gray-50 hover:border-brand-purple"}`}
              >
                <svg
